...
const GOVERNANCE_ADDRESS = "0x098EA33Ec4AE66b8A939642a2E51984bcDeAAcE3";

const PRIVATE_KEY = process.env.DEPLOYER_PRIVATE_KEY as string;
console.log(`n-🔴 => RICH_PRIVATE_KEY:`, PRIVATE_KEY);
...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`n-🔴 => balance:`, ethers.utils.formatEther(balance));
